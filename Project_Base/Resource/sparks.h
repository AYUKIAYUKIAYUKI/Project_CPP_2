...
public:
	...
	static void PointGenerate(D3DXVECTOR3 Pos);		// 集中発生
	static void ScreenGenerate(D3DXVECTOR3 Pos);	// 画面発生
...
private:
	...
	static void PointCreate(D3DXVECTOR3 Pos);	// 集中発生
	static void ScreenCreate(D3DXVECTOR3 Pos);	// 画面発生
