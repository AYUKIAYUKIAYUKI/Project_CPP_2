////============================================================================
////
//// キャラクター(モーション)、ヘッダファイル [character_motion.h]
//// Author : 福田歩希
////
////============================================================================
//
//#ifndef _CHARACTER_MOTION_H_
//#define _CHARACTER_MOTION_H_	// 二重インクルード防止
//
////****************************************************
//// インクルードファイル
////****************************************************
...
//
//	// <special function>
//	CCharacter_Motion();					// コンストラクタ
//	virtual ~CCharacter_Motion() override;	// デストラクタ
//
//	// <function>
...
//	void SetDirectionTaget(float fDirection);	// 目標方角を設定
//
//	// <getter/setter>
